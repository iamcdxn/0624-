...
class ScrollViewController: UIViewController,UIScrollViewDelegate {
    ...
    override func viewDidLayoutSubviews() {
        ...
        //建立PageControl
        codePageControl = UIPageControl(frame: CGRect(x: view.frame.size.width/2 - 30, y: view.frame.size.height - 140, width: 60, height: 37))
        //設定PageControl顏色
        ...
        //設定改動頁數後要執行的方法
        codePageControl.addTarget(self, action: #selector(ScrollViewController.codePageControlAction(_:)), forControlEvents: .ValueChanged)
        //把PageControl加到畫面上
